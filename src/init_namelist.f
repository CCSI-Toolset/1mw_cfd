...
!<keyword category="Initial Condition" required="false">
!  <description>Flag to identify if cyl-subgrid model is used</description>
!  <arg index="1" id="IC" min="1" max="DIMENSION_IC"/>
         ANY_IC_SG = .FALSE.
!</keyword>

!<keyword category="Initial Condition" required="false">
!  <description>Flag to utilize cyl-subgrid model</description>
!  <arg index="1" id="IC" min="1" max="DIMENSION_IC"/>
         LOC_IC_SG(LC) = .FALSE.
!</keyword>

!<keyword category="Initial Condition" required="false">
!  <description>Cylinder diameter in cyl-subgrid model</description>
!  <arg index="1" id="IC" min="1" max="DIMENSION_IC"/>
         IC_D_cyl(LC) = UNDEFINED
!</keyword>

!<keyword category="Initial Condition" required="false">
!  <description>Cylinder spacing in cyl-subgrid model</description>
!  <arg index="1" id="IC" min="1" max="DIMENSION_IC"/>
         IC_a_cyl(LC) = UNDEFINED
!</keyword>

!<keyword category="Initial Condition" required="false">
!  <description>Cylinder temperature in cyl-subgrid model</description>
!  <arg index="1" id="IC" min="1" max="DIMENSION_IC"/>
         IC_T_cyl(LC) = UNDEFINED
!</keyword>
