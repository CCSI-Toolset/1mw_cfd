...
!
        ...
        C_R2NH   = ro_sv(IJK,iSolid) * max(X_s(IJK,iSolid,R2NH),X_zero)   / MW_s(iSolid,R2NH)
        C_R2NCO2 = ro_sv(IJK,iSolid) * max(X_s(IJK,iSolid,R2NCO2),X_zero) / MW_s(iSolid,R2NCO2)
        C_R2NH2  = ro_sv(IJK,iSolid) * max(X_s(IJK,iSolid,R2NH2),X_zero)  / MW_s(iSolid,R2NH2)
        C_HCO3   = ro_sv(IJK,iSolid) * max(X_s(IJK,iSolid,HCO3),X_zero)   / MW_s(iSolid,HCO3)
        C_H2O_s  = ro_sv(IJK,iSolid) * max(X_s(IJK,iSolid,H2O_s),X_zero)  / MW_s(iSolid,H2O_s)
!
!
