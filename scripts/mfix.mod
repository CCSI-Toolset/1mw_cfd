...
!---------------------------------------------------------------------//
  ...
  D_p0(1)         = VALUE_partsizeE-6                  !particle diameter
...
!----------------------------
  ...
  IC_X_s(1,1,1)      = V_sio2E0  !SiO2
  IC_X_s(1,1,2)      = V_amineE0 !R2NH
...
!---------------------------------------------------------------------//
  ...
  BC_X_s(2,1,1)      = V_sio2E0     ! SiO2
  BC_X_s(2,1,2)      = V_amineE0    ! R2NH	--  PolyEthyleneImines
...
!      2*R2NH + CO2(g) <--> R2NCO2- + R2NH2+      --------> Reactions 1 (forward) and 2 (reverse) below
       ...
       REAC_DH(1)      =  VALUE_DH_x     ! J/mol
       REAC_DS(1)      =  VALUE_DS_x     ! J/mol.K
       REAC_E(1)       =  VALUE_E_x      ! J/mol
       REAC_LOGZETA(1) =  VALUE_LOGZETA_x   ! [-]


!   2. Wet CO2 Adsorption
!      R2NH + H2O(g) + CO2(g) <--> HC03- + R2NH2+ --------> Reactions 3 (forward) and 4 (reverse) below

       REAC_DH(2)      =  VALUE_DH_b     ! J/mol
       REAC_DS(2)      =  VALUE_DS_b     ! J/mol.K
       REAC_E(2)       =  VALUE_E_b      ! J/mol
       REAC_LOGZETA(2) =  VALUE_LOGZETA_b   ! [-]

!   3. Water physical Adsorption
!      H2O(g) <--> H2O(abs)                       --------> Reactions 5 (forward) and 6 (reverse) below

       REAC_DH(3)      =  VALUE_DH_a     ! J/mol
       REAC_DS(3)      =  VALUE_DS_a     ! J/mol.K
       REAC_E(3)       =  VALUE_E_a      ! J/mol
       REAC_LOGZETA(3) =  VALUE_LOGZETA_a   ! [-]
